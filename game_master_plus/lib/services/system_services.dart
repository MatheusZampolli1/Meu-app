...
class DeviceMetrics {
  ...
  factory DeviceMetrics.fromMap(Map<dynamic, dynamic> data) {
    ...
    return DeviceMetrics(
      cpuUsage: parseDouble(data['cpuUsage'], 0),
      ramUsage: parseDouble(data['ramUsage'], 0),
      storageFree: parseDouble(data['storageFree'], 0),
      temperature: parseDouble(data['temperature'], 0),
      batteryLevel: parseInt(data['batteryLevel'], 0),
